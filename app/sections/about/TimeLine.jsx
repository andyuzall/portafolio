...
const TimeLineData = [
	{ year: 2023, text: "Comienza mi recorrido como Head Of Data" },
	{ year: 2022, text: "Asumo como Head Of Programmatic" },
	{ year: 2021, text: "Programmatic Trader & Ad Ops" },
	{ year: 2020, text: "Account Manager & Ad Ops" },
];
					...
					{TimeLineData.map((item, index) => {
						return (
							...
							>
								<h3
									tabIndex="0"
									aria-label={"Que hacia en " + item.year}
